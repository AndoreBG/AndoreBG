...
* Prestando suporte técnico e realizando **manutenção de sistemas legados** em **Delphi**.
* Realizando **migração e integração de dados** entre diferentes bancos de dados para Firebird.
